...
class GalleryLocalizationsAm extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'የእርስዎን ሊቀነስ የሚችል ግብር ይጨምሩ! ወደ $count ያልተመደቡ ግብይቶች ምድቦችን ይመድቡ።',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties የሚገኙ ንብረቶች',
