...
class GalleryLocalizationsSr extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Повећајте могући одбитак пореза! Доделите категорије $count недодељеној трансакцији.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Корпа за куповину, $quantity артикал',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties доступан објекат',
...
class GalleryLocalizationsSrLatn extends GalleryLocalizationsSr {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Povećajte mogući odbitak poreza! Dodelite kategorije $count nedodeljenoj transakciji.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Korpa za kupovinu, $quantity artikal',
  ...
  String craneFlyStops(num numberOfStops) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$numberOfStops zaustavljanje',
      zero: 'Direktan',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties dostupan objekat',
