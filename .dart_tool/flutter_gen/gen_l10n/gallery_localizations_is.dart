...
class GalleryLocalizationsIs extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Auktu hugsanlegan frádrátt frá skatti! Úthluta flokkum á $count óúthlutaða færslu.',
    );
    return '$_temp0';
  }
  ...
  String craneFlyStops(num numberOfStops) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$numberOfStops millilending',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties tiltæk eign',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants veitingastaður',
