...
class GalleryLocalizationsBe extends GalleryLocalizations {
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Даступна $totalProperties месца для пражывання',
