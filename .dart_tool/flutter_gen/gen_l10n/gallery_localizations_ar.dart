...
class GalleryLocalizationsAr extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      two: 'يمكنك زيادة خصم الضرائب المحتملة. ضبط الفئات على معاملتين ($count) لم يتم ضبطهما.',
      zero: 'يمكنك زيادة خصم الضرائب المحتملة. ضبط الفئات على $count معاملة لم يتم ضبطها.',
