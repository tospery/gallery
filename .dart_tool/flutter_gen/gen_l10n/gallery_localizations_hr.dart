...
class GalleryLocalizationsHr extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Možda možete dobiti veći povrat poreza! Dodijelite kategorije $count nedodijeljenoj transakciji.',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties dostupan entitet',
