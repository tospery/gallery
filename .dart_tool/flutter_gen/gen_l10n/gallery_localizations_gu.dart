...
class GalleryLocalizationsGu extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'તમારો સંભવિત કર કપાત વધારો! ન સોંપાયેલ $count વ્યવહાર માટે કૅટેગરી સોંપો.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'શોપિંગ કાર્ટ, $quantity આઇટમ',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties પ્રોપર્ટી ઉપલબ્ધ છે',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants રેસ્ટોરન્ટ',
