...
class GalleryLocalizationsRu extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Увеличьте сумму возможного налогового вычета, назначив категории для $count нераспределенной транзакции.',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Доступен $totalProperties вариант жилья',
