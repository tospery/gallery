...
class GalleryLocalizationsFa extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'کاهش مالیات احتمالی را افزایش دهید! دسته‌ها را به $count تراکنش اختصاص‌داده‌نشده اختصاص دهید.',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties ملک در دسترس است',
