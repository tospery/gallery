...
class GalleryLocalizationsHi extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'अपने टैक्स में संभावित छूट को बढ़ाएं! असाइन नहीं किए गए $count लेन-देन के लिए श्रेणियां असाइन करें.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'शॉपिंग कार्ट, इसमें $quantity आइटम हैं',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'किराये पर लेने के लिए $totalProperties जगह उपलब्ध हैं',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants रेस्टोरेंट',
