...
class GalleryLocalizationsDa extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Hæv dit potentielle skattefradrag. Tildel kategorier til $count transaktion, som ingen har.',
    );
    return '$_temp0';
  }
  ...
  String craneFlyStops(num numberOfStops) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$numberOfStops mellemlanding',
      zero: 'Direkte',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties ledig ejendom',
