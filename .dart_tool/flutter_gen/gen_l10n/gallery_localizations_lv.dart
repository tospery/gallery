...
class GalleryLocalizationsLv extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Palieliniet nodokļu atmaksas iespējas! Pievienojiet kategorijas $count darījumam, kuriem vēl nav pievienotas kategorijas.',
      zero: 'Palieliniet nodokļu atmaksas iespējas! Pievienojiet kategorijas $count darījumiem, kuriem vēl nav pievienotas kategorijas.',
    );
    return '$_temp0';
  }
  ...
  String shrineCartItemCount(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$quantity VIENUMS',
      zero: '$quantity VIENUMI',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Iepirkumu grozs, $quantity prece',
      zero: 'Iepirkumu grozs, $quantity preču',
    );
    return '$_temp0';
  }
  ...
  String craneFlyStops(num numberOfStops) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$numberOfStops pārsēšanās',
      zero: '$numberOfStops pārsēšanās',
    );
    return '$_temp0';
  }
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties pieejams īpašums',
      zero: '$totalProperties pieejami īpašumi',
    );
    return '$_temp0';
  }
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants restorāns',
      zero: '$totalRestaurants restorāni',
    );
    return '$_temp0';
  }
