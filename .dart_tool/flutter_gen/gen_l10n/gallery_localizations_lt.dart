...
class GalleryLocalizationsLt extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Gaukite didesnę mokesčių lengvatą! Priskirkite kategorijas $count nepriskirtai operacijai.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Pirkinių krepšelis, $quantity prekė',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties pasiekiama nuosavybė',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants restoranas',
      zero: 'Restoranų nėra',
    );
    return '$_temp0';
  }
