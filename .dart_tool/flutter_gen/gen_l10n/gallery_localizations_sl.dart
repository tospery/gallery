...
class GalleryLocalizationsSl extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      two: 'Povečajte morebitno davčno olajšavo. Dodelite kategorije $count transakcijama brez dodelitev.',
      one: 'Povečajte morebitno davčno olajšavo. Dodelite kategorije $count transakciji brez dodelitev.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Nakupovalni voziček, $quantity izdelek',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties razpoložljiva kapaciteta',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants restavracija',
      zero: 'Ni restavracij',
    );
    return '$_temp0';
  }
