...
class GalleryLocalizationsPt extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Aumente seu potencial de dedução de taxas. Defina categorias para $count transação não atribuída.',
    );
    return '$_temp0';
  }
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Carrinho de compras, $quantity item',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalProperties propriedade disponível',
  ...
  String craneEatRestaurants(num totalRestaurants) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$totalRestaurants restaurante',
